          ...
          <div className="space-y-6">
            ...
            <div className={`p-6 rounded-2xl backdrop-blur-sm border ${
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4 cursor-pointer group hover:scale-105 transition-transform duration-300">
                  <div className={`p-2 rounded-lg ${
                    darkMode ? 'bg-blue-500/20' : 'bg-blue-100'
                  } group-hover:bg-gradient-to-r group-hover:from-blue-500 group-hover:to-cyan-500 transition-all duration-300`}>
                ...
                <div className="flex items-start space-x-4 cursor-pointer group hover:scale-105 transition-transform duration-300">
                  ...
                  } group-hover:bg-gradient-to-r group-hover:from-green-500 group-hover:to-emerald-500 transition-all duration-300`}>
                    <Users className={`w-5 h-5 ${
                      darkMode ? 'text-green-400 group-hover:text-white' : 'text-green-600 group-hover:text-white'
                    }`} />
                  </div>
                  <div>
                    <h5 className={`font-semibold ${
            ...
            <div className={`p-6 rounded-2xl backdrop-blur-sm border ${
              ...
              <div className="space-y-4">
                {achievements.map((achievement, index) => (
                  <div 
                    key={index} 
                    className="cursor-pointer flex items-start space-x-4 group hover:scale-105 transition-transform duration-300"
                  >
