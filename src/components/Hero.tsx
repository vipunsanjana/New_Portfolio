...
import { Github, Linkedin, Mail, Download, Code, Database, Server, Cpu, GitBranch, Terminal, Zap, CloudLightning } from 'lucide-react';
...
const Hero: React.FC<HeroProps> = ({ darkMode }) => {
  ...
  const FloatingLogo = ({ 
    ...
    >
      ...
      <span className={`absolute -bottom-8 left-1/2 transform -translate-x-1/2 text-xs font-mono opacity-0 group-hover:opacity-100 transition-opacity duration-300 ${
  ...
  return (
    <section className={`min-h-screen flex items-center justify-center relative overflow-hidden ${
      ...
      {/* Floating Programming Logos - Left Side */}
      ...
      {/* Floating Programming Logos - Right Side */}
      <div className="hidden lg:block">
        <FloatingLogo 
          icon={Cpu} 
      ...
      {/* Tech Stack Labels - Mobile/Tablet Friendly */}
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8 mt-4">
            <div className={`w-48 h-48 mx-auto mb-10 rounded-full overflow-hidden border-4 ${
          ...
          <p className={`text-base sm:text-lg md:text-xl lg:text-2xl mb-4 leading-relaxed px-4 ${
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 mb-12">
            ...
            <a
              ...
              className={`px-6 sm:px-8 py-3 rounded-lg font-semibold transition-all duration-300 flex items-center justify-center space-x-2 w-full sm:w-auto ${
                darkMode 
